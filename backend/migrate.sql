...
DROP TABLE IF EXISTS form_migration_certificate;
DROP TABLE IF EXISTS form_on_request_degree;
DROP TABLE IF EXISTS form_retotaling;
DROP TABLE IF EXISTS form_repeat_paper;
DROP TABLE IF EXISTS form_name_change;
DROP TABLE IF EXISTS form_duplicate_degree;
DROP TABLE IF EXISTS form_supplementary_exam;
DROP TABLE IF EXISTS form_cgpa_conversion;
DROP TABLE IF EXISTS form_duplicate_grade_card;
